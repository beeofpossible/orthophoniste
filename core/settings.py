...
SECRET_KEY = 'django-insecure-()redk(&%j6sirmmbm2hlbk13&d9fxf^-=oo0fa=y9^74qfdy$'
...
LOGIN_URL = '/admin/login/'  # ou un autre URL si tu as une page de connexion personnalisée
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'apps/static'),  # Dossier pour les fichiers statiques
]
